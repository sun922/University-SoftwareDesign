...
| 시나리오 ID    | 기능     | 예외 상황           | 대응 방법                                    |
| ---------- | ------ | --------------- | ---------------------------------------- |
| SC-UPL-001 | 파일 업로드 | 허용되지 않는 확장자 업로드 | “허용된 파일 형식은 .pdf, .jpg, .docx 입니다” 경고 출력 |
| SC-UPL-002 | 파일 업로드 | 최대 용량 초과        | “최대 10MB까지만 업로드 가능합니다” 오류 메시지            |
| SC-UPL-003 | 파일 업로드 | 중단된 업로드         | “업로드가 중단되었습니다. 다시 시도해 주세요” + 재업로드 버튼     |
| SC-UPL-004 | 파일 업로드 | 중복 파일 업로드       | “같은 파일이 이미 업로드 되어 있습니다” → 확인 버튼 제공       |
| SC-UPL-005 | 파일 업로드 | 업로드 중 페이지 이탈    | “작업이 저장되지 않을 수 있습니다. 정말 나가시겠습니까?” 확인창 표시 |

 <D. 과제 제출/폼 작성>
| 시나리오 ID    | 기능    | 예외 상황          | 대응 방법                            |
| ---------- | ----- | -------------- | -------------------------------- |
| SC-FRM-001 | 과제 제출 | 마감 기한 초과       | “제출 마감 시간이 지났습니다” → 확인 버튼 비활성화   |
| SC-FRM-002 | 과제 제출 | 파일 누락          | “첨부 파일이 필요합니다” 빨간색 경고 문구 출력      |
| SC-FRM-003 | 설문 응답 | 모든 항목 미작성      | “모든 문항에 응답해야 제출이 가능합니다” → 응답 유도  |
| SC-FRM-004 | 과제 제출 | 제출 중 네트워크 끊김   | “연결이 끊겼습니다. 재시도합니다...” 자동 재요청 시도 |
| SC-FRM-005 | 설문/과제 | 제출 버튼 연속 클릭    | “제출 요청 중입니다...” 버튼 비활성화 + 로딩 표시  |
| SC-FRM-006 | 과제 제출 | 제출 완료 후 재제출 시도 | “이미 제출이 완료되었습니다” → 재제출 불가 안내     |
