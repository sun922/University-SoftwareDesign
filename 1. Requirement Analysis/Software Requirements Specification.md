...
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FDO-001** | 학과 소개 열람 기능        | 모두                 |

**교수진 소개** (**FPR**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FPR-001** | 교수진 소개 열람 기능       | 모두                 |

**교육과정 및 수업** (**FCC**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FCC-001** | 커리큘럼 및 수업 정보 열람 기능 | 모두                 |

**공지사항 및 뉴스** (**FNN**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FNN-001** | 공지사항 및 뉴스 열람 기능    | 모두                 |
| **FN-FNN-002** | 공지사항 및 뉴스 등록/수정 기능 | 일반 관리자, 최고 관리자     |

**연구 성과** (**FRS**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FRS-001** | 연구 성과 열람 기능        | 모두                 |

**입학 안내** (**FAD**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FAD-001** | 입학 안내 열람 기능        | 모두                 |

**커뮤니티/게시판** (**FCM**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------------ | ------------------ |
| **FN-FCM-001** | 게시글 작성 기능          | 학생, 교수             |
...
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NDG-RUL-001** | 디자인 일관성 제공 기능 | 모두 |

**디자인 - 반응형 웹** (**NDG-RWD**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NDG-RWD-001** | 해상도별 레이아웃 최적화   | 모두 |
| **NF-NDG-RWD-002** | 모바일 전용 메뉴 제공   | 모두 |
| **NF-NDG-RWD-003** | 터치 기반 요소 크기 및 간격 조절 | 모두 |
...
| 3  | **NF-NDG-003** | 해상도별 레이아웃 최적화   | 모두 |
| 4  | **NF-NDG-004** | 모바일 전용 메뉴 제공   | 모두 |
| 5  | **NF-NDG-005** | 터치 기반 요소 크기 및 간격 조절 | 모두 |
...
| 고유번호               | 요구사항 명칭   | 권한    |
| ------------------ | --------- | ----- |
| **NF-NUI-NMM-001** | 메뉴 구성 방식  | 모두    |
| **NF-NUI-NAM-002** | 권한별 메뉴 표시 | 모두    |
| **NF-NUI-NFT-003** | 페이지 전환 흐름 | 모두    |
| **NF-NUI-NAC-004** | 접근성 보장 UI | 관리자 외 |

| 항목        | 내용                                  |
| --------- | ----------------------------------- |
| 요구사항 고유번호 | NF-NUI-NMM-001                          |
| 요구사항 명칭   | 메뉴 구성 방식                            |
| 요구사항 분류   | 인터페이스 요구사항                          |
...
| 고유번호               | 요구사항 명칭     | 권한  |
| ------------------ | ----------- | --- |
| **NF-NSW-NFE-001** | 프론트엔드 프레임워크 | 관리자 |
| **NF-NSW-NBE-002** | 백엔드 프레임워크   | 관리자 |
| **NF-NSW-NAP-003** | API 통신 방식   | 관리자 |
| **NF-NSW-NJS-004** | 인증 및 세션 관리  | 관리자 |

| 항목        | 내용                                          |
| --------- | ------------------------------------------- |
| 요구사항 고유번호 | NF-NSW-NFE-001                                  |
| 요구사항 명칭   | 프론트엔드 프레임워크                                 |
| 요구사항 분류   | 소프트웨어 요구사항                                  |
...
| 고유번호               | 요구사항 명칭    | 권한  |
| ------------------ | ---------- | --- |
| **NF-NTT-NUT-001** | 기능 단위 테스트  | 관리자 |
| **NF-NTT-NTF-002** | 흐름 기반 테스트  | 관리자 |
| **NF-NTT-NST-003** | 보안 기능 테스트  | 관리자 |
| **NF-NTT-NRT-004** | 반응형 UI 테스트 | 관리자 |
| **NF-NTT-NPT-005** | 권한 제어 테스트  | 관리자 |

| 항목        | 내용                                  |
| --------- | ----------------------------------- |
| 요구사항 고유번호 | NF-NTT-NUT-001                          |
| 요구사항 명칭   | 기능 단위 테스트                           |
| 요구사항 분류   | 테스트 요구사항                            |
...
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NSC-ENC-001** | 개인정보 저장 시 암호화 | 사용자 개개인 |
| **NF-NSC-ENC-002** | 비밀번호 해시 저장 | 사용자 개개인 |

**보안 - SSL/HTTPS 통신 보안** (**NSC-SSL**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NSC-SSL-001** | SSL 인증서 적용 | 모두 |
| **NF-NSC-SSL-002** | 자동 리디렉션 구성 | 모두 |
| **NF-NSC-SSL-003** | 인증서 만료 모니터링 | 최고 관리자 |

**보안 - 실명 인증** (**NSC-RIV**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NSC-RIV-001** | 외부 실명 인증 API 연동 | 학생, 교수 |
| **NF-NSC-RIV-002** | 인증 실패 시 재시도 제한 | 학생, 교수 |
| **NF-NSC-RIV-003** | 인증 로그 기록 | 최고 관리자 |

**보안 - 접근 제어** (**NSC-ACC**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NSC-ACC-001** | 권한 기반의 페이지 접근 제어 | 모두 |
| **NF-NSC-ACC-002** | 관리자 기능 접근 제한 | 최고 관리자 |

**보안 - 보안 로깅 및 추적** (**NSC-LOG**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NF-NSC-LOG-001** | 로그인 기록 저장 | 최고 관리자 |
| **NF-NSC-LOG-002** | 이상 접근 탐지 알림 | 최고 관리자 |

| 보안         | NSC  | Non-functional - Security             |

| 항목        | 내용                                                           |
| --------- | ------------------------------------------------------------ |
| 요구사항 고유번호 | NF-NSC-ENC-001                                                      |
...
| 일련 | 고유번호                | 요구사항 명칭               | 권한 |
| -- | ------------------- | --------------------- | -- |
| 1  | **NQL-GEN-NMQ-001** | 장애 발생 시 10초 이내 복구     | 모두 |
| 2  | **NQL-GEN-NEX-001** | 시스템 가용성 보장 기능         | 모두 |
| 3  | **NQL-GEN-NUX-001** | 에러 발생 시 사용자 피드백 제공 기능 | 모두 |
| 4  | **NQL-GEN-NPR-001** | 시스템 반응 시간 제한 기능	모두 | 모두 |

<품질 - 유지보수 용이성 (NQL-GEN-NMQ)>
| 항목        | 내용                       |
| --------- | ------------------------ |
| 요구사항 고유번호 | NQL-GEN-NMQ-001      |
...
<품질 - 기능 확장성 확보 (NQL-GEN-NEX)>
| 항목        | 내용                                    |
| --------- | ------------------------------------- |
| 요구사항 고유번호 | NQL-GEN-NEX-001                   |
...
<품질 - 사용자 편의성 (NQL-GEN-NUX)>
| 항목        | 내용                                                 |
| --------- | -------------------------------------------------- |
| 요구사항 고유번호 | NQL-GEN-NUX-001                                |
...
<품질 - 빠른 응답 속도 (NQL-GEN-NPR)>
| 항목        | 내용                                           |
| --------- | -------------------------------------------- |
| 요구사항 고유번호 | NQL-GEN-NPR-001                       |
...
| -- | ------------------- | ------------- | --------------------------------------------------------- | --- |
| 1  | **NCR-ENV-NEX-001** | 구현 제외 조건      | 과제 목적상 실제 구현은 수행하지 않음                                     | 모두  |
| 2  | **NCR-ENV-NDL-001** | 제출 일정 제약      | 학기 내 보고서 제출 일정 엄수 필요                                      | 모두  |
| 3  | **NCR-ENV-NTM-001** | 팀 구성 제한       | 외부 인력 참여 없이 팀 내 작성 수행 (외부 전문가 참여 금지 및 팀 내부 작성 필수)         | 모두  |
| 4  | **NCR-ENV-BRC-001** | 브라우저 호환성 제약   | 크롬, 엣지, 사파리 최신 버전에서만 완전 지원<br>IE 미지원 및 기능·화면 동일 유지 필요     | 모두  |
| 5  | **NCR-TEC-OSS-001** | 오픈소스 사용 제한    | 검증된 오픈소스만 사용 가능<br>GPL 등 상업적 제약 라이선스 금지 및 관리자 승인 필요       | 관리자 |
| 6  | **NCR-TEC-FRW-001** | 언어 및 프레임워크 조건 | 백엔드는 Python, 프론트엔드는 React.js 기반 구현<br>다른 스택 사용 시 사전 협의 필요 | 관리자 |

| 항목        | 내용                            |
| --------- | ----------------------------- |
| 요구사항 고유번호 | NCR-ENV-NEX-001               |
| 요구사항 명칭   | 구현 제외 조건                      |
| 요구사항 분류   | 제약 사항                         |
