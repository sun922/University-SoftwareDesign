...
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NDG-RUL-001** | 디자인 일관성 제공 기능 | 모두 |

**디자인 - 반응형 웹** (**NDG-RWD**)
| 고유번호           | 요구사항 명칭            | 권한                 |
| -------------- | ------------- | -- |
| **NDG-RWD-001** | 해상도별 레이아웃 최적화   | 모두 |
